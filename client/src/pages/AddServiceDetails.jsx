...
const AddServiceDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://194.238.16.80:5000/invoices', {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`block mt-6 w-full px-6 py-2 rounded text-white ${loading ? 'bg-gray-400' : 'bg-green-600 hover:bg-green-700'
                }`}
            >
