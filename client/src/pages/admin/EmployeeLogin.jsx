...
const EmployeeLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://194.238.16.80:5000/employee-login", {
                email,
                password
            });
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        ...
                                        try {
                                            const res = await axios.post('http://194.238.16.80:5000/employee-forgot-password', { email: resetEmail });
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        ...
                                        try {
                                            await axios.post('http://194.238.16.80:5000/employee-reset-password', { resetToken, newPassword });
